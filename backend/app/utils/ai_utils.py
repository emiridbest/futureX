...
class InjectiveChatAgent:
    ...
    async def get_response(
        ...
        try:
            ...
            system_message = """You are a helpful AI assistant on Base Chain. `{self.conversations[session_id]}` is the conversation history for this session.
            ...
            You will be answering all things related to Base chain, and help out with
            on-chain functions.
